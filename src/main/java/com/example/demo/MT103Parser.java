...
public class MT103Parser {
	...
	public static void generateOutputMain() {
		//	initHashTab();
	...
	public static void initCorrespondent() {
		...
		correspMap.put("CHASUS33XXX", "BOFAUS3NXXX");
		...
		if(rmaFound == false && isFisrtInCreditChainAccNo == false) {
			...
			if(checkAltRouting()) {
				...
				if(checkCorrespondent()) {
					...
					writeOutwardMT103ToFile(getMT103Output());
				}
	...
	public static  void writeOutwardMT103ToFile(String outwardMT103Msg) {

		try {

			BufferedWriter out = new BufferedWriter(new FileWriter("C:\\TEMP\\output.txt"));
			out.write(outwardMT103Msg);
			out.close();
		}
		catch (IOException e)
		{
	...
	public static  String readPaymentsFile() {
		...
		try {
			contents = new String(Files.readAllBytes(Paths.get("C:\\TEMP\\input.txt")));
